...
<div 
class="bg-white absolute top-0 left-0 bg-gradient-to-b from-purple-500 via-pink-600 to-pink-700 bottom-0 leading-5 h-full w-full overflow-hidden">
</div>
	...
	<div class="flex justify-center self-center  z-10">
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
			<div class="mb-7">
				...
				<p class="text-gray-400">Already have an account? <a href="{{route('login.view')}}"
			...
			<div class="space-y-6">
				<div class="">
					<input name="email" value="{{old('email')}}" class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="email" placeholder="Email">
              </div>
              <div class="space-y-6">
				<div class="">
					<input name="name" value="{{old('name')}}" class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="text" placeholder="name">
              </div>
